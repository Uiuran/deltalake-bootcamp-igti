...
enemnovo = (
    ...
    .load("s3://datalake-igti-edc-penalvad-tf-dev-179819489780/staging-zone/enem")
)
...
enemvelho = DeltaTable.forPath(spark, "s3://datalake-igti-edc-penalvad-tf-dev-179819489780/staging-zone/enem")
